...
public class DeezerInstuctionTest {
    ...
    @Test
    public void deezerInstuctionTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(androidx.appcompat.R.id.alertTitle), withText("Deezer Song API Instruction"),
                        withParent(allOf(withId(androidx.appcompat.R.id.title_template),
                                withParent(withId(androidx.appcompat.R.id.topPanel)))),
                        isDisplayed()));
        textView.check(matches(withText("Deezer Song API Instruction")));
    }
